...
class _AuthentificationCopyWidgetState extends State<AuthentificationCopyWidget>
                                            ...
                                            children: [
                                              ...
                                              Padding(
                                                ...
                                                child: Text(
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                    'gaerlz6u' /* Commencez avec Afrohealth insc... */,
                                                  ),
                                                  textAlign: TextAlign.start,
                                                  style: FlutterFlowTheme.of(
                                                          context)
                                                    ...
                                                    decoration: InputDecoration(
                                                      labelText:
                                                          FFLocalizations.of(
                                                                  context)
                                                              .getText(
                                                        'uokrome7' /* Confirmer le mot de Passe */,
                                                      ),
                                                      labelStyle:
                                                          FlutterFlowTheme.of(
                                                                  context)
                                                ...
                                                child: Padding(
                                                  ...
                                                  child: FFButtonWidget(
                                                    onPressed: () async {
                                                      ...
                                                      await NotificationPreferencesTable()
                                                          .insert({
                                                        'user_id': valueOrDefault(
                                                            currentUserDocument
                                                                ?.id,
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              Text(
                                                FFLocalizations.of(context)
                                                    .getText(
                                                  'm99dq9a9' /* Heureux de vous revoir !  */,
                                                ),
                                                textAlign: TextAlign.start,
                                                style: FlutterFlowTheme.of(
                                                        context)
                                              ...
                                              Padding(
                                                ...
                                                child: Text(
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                    'ltadmuer' /* Remplissez les information ci ... */,
                                                  ),
                                                  textAlign: TextAlign.start,
                                                  style: FlutterFlowTheme.of(
                                                          context)
