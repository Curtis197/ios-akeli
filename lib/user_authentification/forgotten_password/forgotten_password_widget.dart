...
class ForgottenPasswordWidget extends StatefulWidget {
  ...
  static String routeName = 'forgottenPassword';
  static String routePath = '/forgottenPassword';
          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: Text(
                  FFLocalizations.of(context).getText(
                    'rpo75qrc' /* We will send you an email with... */,
                  ),
