...
class MealDetailWidget extends StatefulWidget {
  ...
  static String routePath = '/mealDetail';
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<MealRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<MealRow> mealDetailMealRowList = snapshot.data!;

        final mealDetailMealRow = mealDetailMealRowList.isNotEmpty
            ? mealDetailMealRowList.first
            : null;
                      ...
                      child: SingleChildScrollView(
                        child: Column(
                          ...
                          children: [
                            ...
                            if (mealDetailMealRow?.personal == false)
                              Padding(
                                padding: EdgeInsetsDirectional.fromSTEB(
                                    0.0, 25.0, 0.0, 0.0),
                                  ...
                                  builder: (context, snapshot) {
                                    ...
                                    return Container(
                                      ...
                                      child: CarouselSlider.builder(
                                        itemCount:
                                            carouselReceipeImageRowList.length,
                                        itemBuilder:
                            ...
                            if (mealDetailMealRow!.personal! &&
                                (mealDetailMealRow.imageUrl != null &&
                                    mealDetailMealRow.imageUrl != ''))
                              Align(
                                alignment: AlignmentDirectional(0.0, 0.0),
                                child: ClipRRect(
                            ...
                            Align(
                              ...
                              child: Text(
                                () {
                                  if (mealDetailMealRow.mealType ==
                                      'breakfast') {
                                    return 'Petit-Déjeuner';
                                  } else if (mealDetailMealRow.mealType ==
                                      'lunch') {
                                    return 'Déjeuner';
                                  } else if (mealDetailMealRow.mealType ==
                                      'dinner') {
                                ...
                                child: Container(
                                  ...
                                  child: FutureBuilder<List<MealRow>>(
                                    future: (_model.requestCompleter ??=
                                            Completer<List<MealRow>>()
                                              ..complete(
                                                  MealTable().querySingleRow(
                                                queryFn: (q) => q.eqOrNull(
                                                  'id',
                                                  mealDetailMealRow.id,
                                                ),
                                              )))
                                        .future,
                                    builder: (context, snapshot) {
                                      ...
                                      List<MealRow> rowMealRowList =
                                          snapshot.data!;

                                      final rowMealRow =
                                          rowMealRowList.isNotEmpty
                                              ? rowMealRowList.first
                                              : null;
                                        ...
                                        children: [
                                          Text(
                                            FFLocalizations.of(context).getText(
                                              'xztahgvw' /* Vous avez consommé ce repas */,
                                            ),
                                            style: FlutterFlowTheme.of(context)
                                                .titleLarge
                                                .override(
                                  ...
                                  if (!mealDetailMealRow.personal!)
                                    FutureBuilder<List<ReceipeRow>>(
                                      ...
                                      builder: (context, snapshot) {
                                        ...
                                        List<ReceipeRow> rowReceipeRowList =
                                            snapshot.data!;

                                        final rowReceipeRow =
                                            rowReceipeRowList.isNotEmpty
                            ...
                            if (mealDetailMealRow.personal ?? true)
                              Align(
                                alignment: AlignmentDirectional(0.0, 0.0),
                                child: Text(
                                  valueOrDefault<String>(
                            ...
                            if (mealDetailMealRow.personal == false)
                              Padding(
                                padding: EdgeInsetsDirectional.fromSTEB(
                                    20.0, 0.0, 20.0, 0.0),
                                child: StreamBuilder<List<MealIngredientsRow>>(
                                  ...
                                  builder: (context, snapshot) {
                                    ...
                                    List<MealIngredientsRow>
                                        listViewMealIngredientsRowList =
                                        snapshot.data!;
                                    ...
                                    return ListView.separated(
                                      ...
                                      itemCount:
                                          listViewMealIngredientsRowList.length,
                                      separatorBuilder: (_, __) =>
                                          SizedBox(height: 15.0),
                                      itemBuilder: (context, listViewIndex) {
                                        final listViewMealIngredientsRow =
                                            listViewMealIngredientsRowList[
                                                listViewIndex];
                                        return Material(
                                    ...
                                    return ListView.separated(
                                      ...
                                      itemBuilder: (context, listViewIndex) {
                                        final listViewStepRow =
                                            listViewStepRowList[listViewIndex];
                                        return Material(
                                          color: Colors.transparent,
                                          elevation: 3.0,
                                          shape: RoundedRectangleBorder(
                                            ...
                                            child: Padding(
                                              ...
                                              child: Row(
                                                ...
                                                crossAxisAlignment:
                                                    CrossAxisAlignment.start,
                                                children: [
                                                  if ((listViewStepRow.number !=
                                                          null) &&
                                                      !listViewStepRow.title!)
                                                    Text(
                                                      valueOrDefault<String>(
                                                        listViewStepRow.number
                                                            ?.toString(),
                                                        '1',
                                                      ),
                                                      style:
                            ...
                            Align(
                              ...
                              child: Column(
                                ...
                                children: [
                                  Text(
                                    FFLocalizations.of(context).getText(
                                      '8yz5uwlk' /* Voulez-vous choisir une autre ... */,
                                    ),
                                    style: FlutterFlowTheme.of(context)
                                        .titleLarge
                                        .override(
                                  ...
                                  FFButtonWidget(
                                    onPressed: () async {
                                      FFAppState().mealID = widget.mealID!;
                                      safeSetState(() {});
                            ...
                            Align(
                              ...
                              child: Column(
                                ...
                                children: [
                                  Text(
                                    FFLocalizations.of(context).getText(
                                      '6ttlc5wn' /* Voulez choisir un repas person... */,
                                    ),
                                    style: FlutterFlowTheme.of(context)
                                        .titleLarge
                                        .override(
                            ...
                            if (!mealDetailMealRow.personal!)
                              wrapWithModel(
                                ...
                                child: SimilarReceipeWidget(
                                  receipeID: mealDetailMealRow.receipeId!,
                                ),
                              ),
