...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: MealPlannerWidget.routeName,
          path: MealPlannerWidget.routePath,
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'Meal_Planner')
              : MealPlannerWidget(),
        ),
        FFRoute(
          name: MealDetailWidget.routeName,
          path: MealDetailWidget.routePath,
          builder: (context, params) => MealDetailWidget(
        ...
        FFRoute(
          name: ForgottenPasswordWidget.routeName,
          path: ForgottenPasswordWidget.routePath,
        ...
        FFRoute(
          ...
          builder: (context, params) => ChatPageWidget(
            conversation: params.getParam<ChatConversationRow>(
              'conversation',
              ParamType.SupabaseRow,
            ),
            destinedUserId: params.getParam(
              'destinedUserId',
              ParamType.int,
            ),
            conversationParticipant:
                params.getParam<ConversationParticipantRow>(
              'conversationParticipant',
              ParamType.SupabaseRow,
            ),
          ),
        ...
        FFRoute(
          name: GroupPageWidget.routeName,
          path: GroupPageWidget.routePath,
        ...
        FFRoute(
          name: CreateEditProfilWidget.routeName,
          path: CreateEditProfilWidget.routePath,
          builder: (context, params) => CreateEditProfilWidget(),
        ),
        FFRoute(
          name: EditInfoWidget.routeName,
          path: EditInfoWidget.routePath,
          builder: (context, params) => EditInfoWidget(),
        ),
        FFRoute(
          name: PaymentSubscriptionWidget.routeName,
          path: PaymentSubscriptionWidget.routePath,
          builder: (context, params) => PaymentSubscriptionWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          ...
          builder: (context, params) => ShoppingListWidget(
            shoppingList: params.getParam<ShoppingListRow>(
              'shoppingList',
              ParamType.SupabaseRow,
            ),
          ),
        ...
        FFRoute(
          name: DietPlanWidget.routeName,
          path: DietPlanWidget.routePath,
        ...
        FFRoute(
          name: RecipeResearchingListWidget.routeName,
          path: RecipeResearchingListWidget.routePath,
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'recipeResearchingList')
        ...
        FFRoute(
          name: CguWidget.routeName,
          path: CguWidget.routePath,
          builder: (context, params) => CguWidget(),
        ),
        FFRoute(
          name: RgpdWidget.routeName,
          path: RgpdWidget.routePath,
          builder: (context, params) => RgpdWidget(),
        ),
        FFRoute(
          name: ConditionWidget.routeName,
          path: ConditionWidget.routePath,
          builder: (context, params) => ConditionWidget(),
        ),
        FFRoute(
