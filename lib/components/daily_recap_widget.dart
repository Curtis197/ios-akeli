...
import 'daily_recap_model.dart';
export 'daily_recap_model.dart';
...
class _DailyRecapWidgetState extends State<DailyRecapWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DailyRecapModel());
            ...
            child: Column(
              ...
              children: [
                ...
                AuthUserStreamWidget(
                  builder: (context) => FutureBuilder<List<MealConsumedRow>>(
                    future: MealConsumedTable().querySingleRow(
                      queryFn: (q) => q
                          .eqOrNull(
                            'date',
                            supaSerialize<DateTime>(widget.track?.date),
                          )
                          .eqOrNull(
                            'user_id',
                    ...
                    builder: (context, snapshot) {
                      ...
                      List<MealConsumedRow> containerMealConsumedRowList =
                          snapshot.data!;
                      ...
                      final containerMealConsumedRow =
                          containerMealConsumedRowList.isNotEmpty
                              ? containerMealConsumedRowList.first
                              : null;
